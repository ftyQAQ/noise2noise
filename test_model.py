...
def get_args():
    ...
    args = parser.parse_args(['--image_dir=G:\noise2noise\cellpro_data\or',
                              '--weight_file=G:/noise2noise/data_tiff/test1/weights.013-138.165-43.84846.hdf5',
                              '--output_dir=weight_file=G:/noise2noise/data_tiff/test1/out'])
    return args
